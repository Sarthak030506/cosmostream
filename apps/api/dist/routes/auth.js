        ...
        try {
            ...
            if (existingUser.rows.length > 0) {
                ...
                if (!oauthProviders.includes('google')) {
                    ...
                    await db_1.pool.query('UPDATE users SET oauth_providers = $1 WHERE id = $2', [
                ...
                // Create new user
                const result = await db_1.pool.query(`INSERT INTO users (email, password_hash, name, role, oauth_providers)
               VALUES ($1, $2, $3, $4, $5)
               RETURNING *`, [
                    email,
